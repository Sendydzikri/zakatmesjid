...
<body class="hold-transition login-page" background=<?php echo base_url(); ?>'/assets/login/gambar/jual_bg.jpg'>
<div class="login-box">
  <div class="login-logo">
    <b>SISTEM INFORMASI ZAKAT</b>
  <!--   <b1>MESJID KHUSNUL KHOTIMAH</b1> -->
  </div>
  <!-- /.login-logo -->
